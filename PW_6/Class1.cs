        ...
        public static void deserializaciya(string sslka)
        {
            if (sslka.Contains("txt"))
            {
                ...
                if (ssl.Key == ConsoleKey.F1)
                {
                    ...
                    using (FileStream fs = new FileStream("C:\\Users\\user\\source\\repos\\PW_6\\Result.xml", FileMode.OpenOrCreate))
                    {
                ...
                if (ssl.Key == ConsoleKey.F2)
                {
                    ...
                    File.WriteAllText("C:\\Users\\user\\source\\repos\\PW_6\\Result.json", jsom);
                }
            }
            if (sslka.Contains("json"))
            {
                ...
                if (ssl.Key == ConsoleKey.F2)
                {
                    ...
                    b += ihz.f3 + "\n";
                    b += ihz.f4 + "\n";
                    File.WriteAllText("C:\\Users\\user\\source\\repos\\PW_6\\Result.txt", b);
                }
            }
            if (sslka.Contains("xml"))
            {
                Fig ih;
                XmlSerializer xml = new XmlSerializer(typeof(Fig));
                using (FileStream fs = new FileStream("C:\\Users\\user\\source\\repos\\PW_6\\Result.xml", FileMode.Open))
                {
